 ...
 * 32 bit adjustment : Olivier Landemarre
 *
...
Mode mode[1] =
	{{PIXEL_SIZE*8, CHUNKY | CHECK_PREVIOUS | TRUE_COLOUR, {r_32, g_32, b_32, none, none, none}, 0,  2, 2, 1}};

extern Device device;

char driver_name[] = "SAGA32";
...
{
	ULONG buffer;
	ULONG vram_size = (ULONG)width * height * PIXEL_SIZE;
