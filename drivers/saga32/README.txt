...
Currently, it only supports 32-bit ARVB video modes, with some resolutions.
...
5) Of course you can also run FreeMiNT and XaAES or MyAES to get more benefits of these
new video modes.
...
- SAGA fVDI 32 bit bit version : Olivier Landemarre
