...
static void replace(short *addr, short *addr_fast, int line_add, short *pattern, int x, int y, int w, int h, short foreground, short background)
{
	int i, j;
	unsigned int pattern_word, mask;
	unsigned short foregroundx2[2];
	unsigned long *addr32,*foreground32=(unsigned long *)foregroundx2;
	foregroundx2[0]=(unsigned short)foreground;
	foregroundx2[1]=(unsigned short)foreground;
