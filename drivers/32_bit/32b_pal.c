/*
 * 32 bit palette handling routines, by Olivier Landemarre.
...
void CDECL
c_get_colour(Virtual *vwk, long colour, PIXEL *foreground, PIXEL *background)
{
	Colour *local_palette, *global_palette;
	Colour *fore_pal, *back_pal;

/*Cconws("c_get_color in\015\012");*/
	...
	*foreground = *(PIXEL *)&fore_pal[(short)colour].real;
	*background = *(PIXEL *)&back_pal[colour >> 16].real;
}
