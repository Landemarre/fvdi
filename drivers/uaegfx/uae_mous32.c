 ...
 * Adapatation 32 bits Olivier Landemarre
 *
...
static MFDB mouse_mfdb = {NULL, 16, 16, 1, 1, 1};

/* We must save the mouse background */
static PIXEL backup_data[16*16];
static MFDB mouse_backup_mfdb = {backup_data, 16, 16, 1, 0, PIXEL_SIZE*8};
...
{
/*	Cconws("c_mouse_draw in\015\012");*/	
...
/*Cconws("c_mouse_draw out\015\012");	*/
	return 0;
}
